#> rsbase:is_powering_weakly/neg_z
...
execute if score result rsbase matches 0 store result score result rsbase if block ~ ~ ~ minecraft:redstone_wire[east=none,west=none,north=none] unless block ~ ~ ~ minecraft:redstone_wire[power=0,south=none]
