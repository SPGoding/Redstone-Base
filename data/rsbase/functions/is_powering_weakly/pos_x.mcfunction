#> rsbase:is_powering_weakly/pox_x
...
execute if score result rsbase matches 0 store result score result rsbase if block ~ ~ ~ minecraft:redstone_wire[east=none,south=none,north=none] unless block ~ ~ ~ minecraft:redstone_wire[power=0,west=none]
